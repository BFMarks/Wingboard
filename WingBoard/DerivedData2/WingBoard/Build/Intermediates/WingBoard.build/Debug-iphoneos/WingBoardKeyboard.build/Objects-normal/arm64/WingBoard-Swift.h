...
@interface KeyboardViewController : UIInputViewController <UIScrollViewDelegate, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@property (nonatomic, copy) NSArray<UIImage *> * _Nonnull picture;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)removeTableView;
- (void)removeActualKeyboard;
- (void)getGeneralFromServer;
- (void)didTapforNewLines;
- (void)didTapForDrinking;
- (void)didTapForCuddling;
- (void)didTapForUserSubmission;
- (void)didTapForPassion;
- (void)didTapForBestOfLines;
- (void)didTapForOtherTeam;
- (void)clearTable;
- (void)clearHeader;
